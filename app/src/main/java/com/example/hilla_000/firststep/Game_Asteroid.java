 ...
 */
public class Game_Asteroid extends SettingsMenuActivity{
            ...
            op2Button.setOnClickListener(
                    new View.OnClickListener(){
                        ...
                        public void onClick(View v){
                            ...
                            result.setTextSize(75);
                            Intent intent = new Intent(getApplicationContext(), Game_Asteroid_Level2.class);
    ...
    {
        mainPlayer = MediaPlayer.create(Game_Asteroid.this, R.raw.incorrect);
    }
